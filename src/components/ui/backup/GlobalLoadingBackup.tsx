...
/**
 * Global Loading UI (Backup)
 * 
 * Previously used by Next.js during route transitions when Suspense was triggered.
 * Preserved here for future reference or custom modal loading if needed.
 */
export default function GlobalLoadingBackup() {
  return (
