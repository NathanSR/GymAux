            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 pb-20">
                ...
                <section className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full py-5 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-[32px] text-zinc-400 font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:border-lime-400 hover:text-lime-500 transition-all active:scale-[0.98] cursor-pointer"
                    >
                        <Plus size={18} />
                        {t('addExercise')}
                    </button>
