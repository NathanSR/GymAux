        ...
        >
            <div className="flex flex-col gap-4 p-1">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-3.5 flex items-start gap-3">
                    <div className="w-8 h-8 rounded-xl bg-lime-400/10 border border-lime-400/20 text-lime-600 dark:text-lime-400 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <Info size={18} />
                    </div>
                                    ...
                                    <div className="bg-white dark:bg-zinc-950/60 rounded-2xl p-2.5 border border-zinc-200 dark:border-zinc-800/50 flex items-center justify-between gap-2 shadow-xs">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            <button
                                                ...
                                                className="w-9 h-9 sm:w-10 sm:h-10 bg-zinc-100 dark:bg-zinc-800/80 hover:bg-zinc-200 dark:hover:bg-zinc-700 hover:border-zinc-300 dark:hover:border-zinc-600 border border-zinc-200 dark:border-zinc-700/50 text-zinc-700 dark:text-zinc-200 rounded-xl flex items-center justify-center active:scale-95 transition-all shadow-xs cursor-pointer"
                                            >
                                                <Minus size={16} />
                                            </button>
                                            <button
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800/80 p-3.5 rounded-2xl flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                        {drops.map((d, i) => (
                            <React.Fragment key={i}>
                                ...
                                {i < drops.length - 1 && (
                                    <ArrowRight size={12} className="text-zinc-400 dark:text-zinc-600 flex-shrink-0" />
                                )}
                            </React.Fragment>
                        ))}
                    </div>
                ...
                {/* Action buttons */}
                <div className="grid grid-cols-2 gap-3 pt-2 border-t border-zinc-200 dark:border-zinc-800/60 mt-1">
                    <button
                        type="button"
                        onClick={handleClear}
                        className="py-3.5 bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white border border-zinc-200 dark:border-zinc-800 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all active:scale-[0.98] cursor-pointer"
                    >
                        {t('clear')}
                    </button>
                    <button
                        ...
                        className="py-3.5 bg-lime-400 text-zinc-950 font-black rounded-2xl text-xs uppercase tracking-wider hover:bg-lime-300 hover:shadow-lg hover:shadow-lime-400/20 transition-all active:scale-[0.98] cursor-pointer"
                    >
                        {t('confirm')}
                    </button>
                </div>
